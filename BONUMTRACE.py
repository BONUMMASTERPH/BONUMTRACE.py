...
def BONUMTRACE():
	print("  BONUMTRACE
print(" WEBSITE SCAN DETECTION WEBSITE)

print("  # Pagkatugma: 
print("    Anumang platform gamit ang Python 2.7
print("  Mga Kinakailangan: Python 2.7Modules (kasama): Colorama, MagandaSoup 
print(" ## paglalarawan: Ang BONUMTRACE ay isang All-In-One Tool para sa Pagsubok sa Penetration.
print("  Ito ay espesyal na na-program para sa Mga Pagsubok sa Penetration at Mga Mananaliksik ng Seguridad upang gawing mas madali ang kanilang trabaho, sa halip na ilunsad ang iba't ibang mga tool para sa pagsasagawa ng iba't ibang gawain. 
print("  Ang BONUMTRACE ay nagbibigay ng maraming mga zv at mga tampok ng pagtuklas na nagtitipon ng impormasyon sa target at nakakahanap ng iba't ibang mga bahid dito. 
print("  # Mga Tampok: 


print(" BONUMCLAN ENJOY!
(print(" Created BY BONUMMASTER)
	
	print("
	print(" 
	print(" 
	print("" Sub-domain ScanningPort Scanning Wordpress Scanning Wordpress Username Enumeration Wordpress Backup Grabbing Sensitive File DetectionSame-Site Scripting Scanning Mag-click sa Jacking Detection Powerful XSS kahinaan sa pag-scanSQL Injection kahinaan sa pag-scanUser-Friendly UI 
print("  Paggamit: python BONUMTRACE.py
